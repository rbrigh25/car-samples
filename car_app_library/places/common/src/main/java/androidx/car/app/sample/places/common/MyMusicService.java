...
public class MyMusicService extends MediaBrowserServiceCompat {
    ...
    public void bringAppForward(){
        Log.d("RYAN", "bringAppForward: ");
    ...
    public void onCreate() {
        super.onCreate();
        Log.d("RYAN", "onCreate: are we even here");
        bringAppForward();
        mSession = new MediaSessionCompat(this, "MyMusicServiceR");
